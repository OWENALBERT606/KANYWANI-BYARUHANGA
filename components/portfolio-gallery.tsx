...
const PORTFOLIO_IMAGES: PortfolioImage[] = [
  {
    id: "1",
    src: "/WhatsApp Image 2026-06-09 at 09.21.17.jpeg",
        ...
        {PORTFOLIO_IMAGES.map((image) => (
          ...
          >
            <Image
              ...
              width={400}
              height={400}
              className={`w-full h-full group-hover:scale-105 transition-transform duration-300 ${image.contain ? "object-contain" : "object-cover"}`}
            />
          </div>
        ))}
      </div>
